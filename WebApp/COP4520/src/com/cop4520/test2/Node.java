...
public class Node {
	...
	// leaf constructor
	public Node(int key, int value, RemoteClient remoteClient) {
		this.key = key;
		this.value = value;
	...
	public Node(int key, int value, RemoteClient remoteClient, AtomicStampedReference<Node> left, AtomicStampedReference<Node> right) {
		this.key = key;
		this.value = value;
		this.left = left;
		this.right = right;
