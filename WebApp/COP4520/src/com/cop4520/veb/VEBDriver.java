...
/*  System.out.println(seq.isMember(seq,3));
    ...
    System.out.println("------------------------------");
    */
    ParallelVEB parTree = new ParallelVEB(100000);
    Thread t1 = new Thread(new VEBThread(100000,true,parTree,false));
    Thread t2 = new Thread(new VEBThread(100000,false,parTree,false));
    Thread t3 = new Thread(new VEBThread(100000,true,parTree,false));
    Thread t4 = new Thread(new VEBThread(100000,false,parTree,false));
    Thread t5 = new Thread(new VEBThread(100000,true,parTree,true));
    Thread t6 = new Thread(new VEBThread(100000,false,parTree,true));
    Thread t7 = new Thread(new VEBThread(100000,false,parTree,true));
    Thread t8 = new Thread(new VEBThread(100000,false,parTree,true));
